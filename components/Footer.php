    ...
    <div class="container overflow-hidden">
      <div class="row gy-4 gy-lg-0 justify-content-xl-between">
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="widget">
            <a href="#!">
              <img src="images/Logo.png" alt="BootstrapBrain Logo" width="175" height="50">
            </a>
          </div>
        </div>
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="widget">
            ...
            <address class="mb-4">1102 Hlaing Township, 33 Street, Yangon, Myanmar</address>
            <p class="mb-1">
              <a class="link-secondary text-decoration-none" href="#">09555333012</a>
            </p>
            <p class="mb-0">
              <a class="link-secondary text-decoration-none" href="#">ecopacks@gmail.com</a>
            </p>
          </div>
        </div>
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="widget">
            ...
            <ul class="list-unstyled">
              <li class="mb-2">
                <a href="Home.php" class="link-secondary text-decoration-none">Home</a>
              </li>
              <li class="mb-2">
                <a href="About.php" class="link-secondary text-decoration-none">About</a>
              </li>
              <li class="mb-2">
                <a href="Shop.php" class="link-secondary text-decoration-none">Shop</a>
              </li>
              <li class="mb-2">
                <a href="CartPage.php" class="link-secondary text-decoration-none">Cart</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="row gy-4 gy-md-0 align-items-md-center">
        <div class="col-xs-12 col-md-7 order-1 order-md-0">
          <div class="copyright text-center text-md-start">
            &copy; 2024. Eco-Packs All Rights Reserved.
          </div>
        </div>
